              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text("Who are you interested in connecting with?",style: TextStyle(color: kAppThemeColor,fontWeight: FontWeight.bold,fontSize: 30),),
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children: [
                                ...
                                child: FittedBox(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      image: DecorationImage(
                                        image:
                                            AssetImage('assets/images/male.gif'),
                                      ),
                                    ),
                                  ),
                                ),
                  ...
                  IconButton(
                    ...
                    icon: Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image:
                              AssetImage("assets/images/call.gif"))),
                    ),
                  ),
                ],
              ),
